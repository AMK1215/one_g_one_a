...
class CQ9FishingGaming extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:c-q9-fishing-gaming';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/cq9_fishing.json');
        $outputFilePath = base_path('app/Console/Commands/data/CQ9FishingModify.json');
