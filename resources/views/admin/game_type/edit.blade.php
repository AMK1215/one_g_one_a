    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card  col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1" style="border-radius: 15px;">
                ...
                <form  action="{{ route('admin.gametypes.update',[$gameType->id,$productId]) }}" method="post" enctype="multipart/form-data">                    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-12 offset-lg-0 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$gameType->products[0]['name']}}" readonly>                                    @error('name')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
